...
@testable import DahliaRuntimeSupport
    ...
    struct SummaryDocumentResponseSchemaTests {
        ...
        func requiresTextContainersWithoutExtraFields() throws {
            ...
            #expect(columns["maxItems"] as? Int == SummaryTableRenderLimits.maximumTableColumns)
            #expect(rows["maxItems"] as? Int == SummaryTableRenderLimits.maximumTableRows)
            #expect(row["maxItems"] as? Int == SummaryTableRenderLimits.maximumTableColumns)
