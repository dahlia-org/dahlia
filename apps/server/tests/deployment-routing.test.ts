...
describe("deployment routing", () => {
  it("routes OAuth discovery through the Worker instead of the SPA", () => {
    ...
    expect(d1Migrations).toEqual(["20260903173555_lying_slipstream.sql", "20260905172528_unique_marvel_zombies.sql", "20260905172654_sync_history_backfill.sql", "20260906125718_dashing_roughhouse.sql", "20260907070728_dashing_sinister_six.sql", "20260907091207_funny_black_bird.sql", "20260907131015_big_excalibur.sql", "20260907132433_stiff_slyde.sql", "20260907172550_nice_starhawk.sql", "20260908013212_chief_enchantress.sql", "20260908040349_cuddly_brood.sql", "20260908040515_summary_version_backfill.sql"]);
