...
The package exports the backend extension contract from `dahlia-ai`, Dashboard components from `dahlia-ai/client`, shared styles from `dahlia-ai/client/styles.css`, and its migration manifest. Server migrations must run before consumer migrations.
