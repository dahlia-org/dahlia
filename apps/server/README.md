...
The sidebar exposes Home, All Workspaces, the current Workspace selector, search beside the logo, and the Project tree;
The account menu contains Account settings, a link to organization management, and sign-out. Organization selection does not scope the Workspace list.
...
The sidebar groups Home, Workspaces, and Search into an icon row with accessible names and tooltips. The current Workspace button opens a popover with the selected Workspace marked.
