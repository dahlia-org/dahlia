...
async function createWorkspaceRecord(organizationId: string, name: string, encryption: string | undefined, onRecovery: (active: boolean) => void) {
...
function workspaceEncryptionFields(enabled: boolean): DialogField[] {
