...
const sqliteHistory = ["20260905172528_unique_marvel_zombies/migration.sql", "20260905172654_sync_history_backfill/migration.sql", "20260906125718_dashing_roughhouse/migration.sql", "20260907070728_dashing_sinister_six/migration.sql", "20260907091207_funny_black_bird/migration.sql", "20260907131015_big_excalibur/migration.sql", "20260907132433_stiff_slyde/migration.sql", "20260907172550_nice_starhawk/migration.sql", "20260908013212_chief_enchantress/migration.sql"];
