...
for mapping in gpt-5-6-luna gpt-6-astra gpt-5-6-sol gpt-5-6-terra kimi-k3 deepseek-v4-pro:deepseek-v4-pro-0813 glm-5-3-flash glm-5-3 gemini-3-8-flash gemini-3-7-flash embedding:qwen3-embedding-0-6b codex-auto-review:gpt-5-6-luna; do
