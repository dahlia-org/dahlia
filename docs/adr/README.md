...
| [0022](0022-unify-main-window-navigation-and-meeting-content.md) | Main window / Recording UI / Transcript evidence | 画面ごとの列構成、会議内タブ、DB-backed参照ジャンプ、録音停止配置を統合する | Accepted; builds on 0006 and 0009 |
