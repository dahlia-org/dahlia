...
| [0033](0033-use-local-fts5-search-projection.md) | Search / Database projection | Lindera と FTS5 による再構築可能なローカル検索索引を使う | Accepted; builds on 0006, 0007, and 0009; amended by 0034 and 0040 |
...
| [0040](0040-user-configurable-meeting-search-field-weights.md) | Search / Settings | ミーティング検索の順位をユーザー設定のフィールド重みで決める | Accepted; amends 0033 and 0034 |
