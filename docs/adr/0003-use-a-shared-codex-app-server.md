...
- stdio transport: `apps/desktop/Sources/Dahlia/Services/CodexAppServerProcessTransport.swift`
- Dahlia 専用 CODEX_HOME: `apps/desktop/Sources/Dahlia/Services/CodexHome.swift`
